...
import { Award, Heart, Leaf, Users, Star, Calendar, Shield, Sparkles } from 'lucide-react';
...
const About = () => {
  ...
  const teamMembers = [
    {
      ...
      specialty: 'Color Specialist & Organic Hair Care Expert',
      experience: '15+ years',
      bio: 'Lisa founded LS Hair Elementz with a vision to revolutionize hair care through natural, organic methods. Her expertise in color and commitment to healthy hair practices has made her a sought-after stylist in the community.'
    },
    {
      name: 'Sarah Johnson',
      role: 'Senior Stylist',
      image: 'https://images.pexels.com/photos/774909/pexels-photo-774909.jpeg?auto=compress&cs=tinysrgb&w=400',
      specialty: 'Curly Hair Expert & Texture Specialist',
      experience: '10+ years',
      bio: 'Sarah specializes in curly and textured hair, helping clients embrace their natural beauty. Her gentle approach and expertise in curl patterns make her a favorite among clients with natural hair.'
    },
    {
      name: 'Maya Rodriguez',
      role: 'Styling Artist',
      image: 'https://images.pexels.com/photos/1181686/pexels-photo-1181686.jpeg?auto=compress&cs=tinysrgb&w=400',
      specialty: 'Extensions & Protective Styling',
      experience: '8+ years',
      bio: 'Maya is our extensions and braiding specialist, creating stunning protective styles that promote hair health. Her artistic eye and technical skills deliver beautiful, long-lasting results.'
    }
  ];
  ...
  const achievements = [
    {
      icon: Star,
      title: 'Best Hair Salon 2024',
      description: 'Voted Best Hair Salon by City Magazine readers'
    },
    {
      icon: Leaf,
      title: 'Organic Certified',
      description: 'Certified organic product retailer and service provider'
    },
    {
      icon: Calendar,
      title: '5+ Years Excellence',
      description: 'Serving the community with consistent quality since 2019'
    },
    {
      icon: Shield,
      title: 'Licensed Professionals',
      description: 'All stylists are licensed and continuously trained'
    }
  ];
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              ...
              <div className="relative">
                <img
                  ...
                  alt="Salon interior showcasing modern styling stations"
        ...
        <div className="mb-16">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {achievements.map((achievement, index) => {
              ...
              return (
                <div key={index} className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-2xl p-6 text-center border border-purple-100">
        ...
        <div className="text-center">
          <div className="max-w-3xl mx-auto bg-gradient-to-r from-purple-600 to-pink-600 rounded-3xl p-8 text-white">
            ...
            <p className="text-lg leading-relaxed opacity-90">
              ...
              maintaining the health and integrity of your hair. We believe that true beauty 
              comes from healthy hair, and healthy hair comes from natural care.
            </p>
          </div>
        </div>
      </div>
